...
const TYPE_DISPLAY_LIST = {
  CODE: "code",
  BLOG: "blog",
};

const DisplayListItem = ({
  type = TYPE_DISPLAY_LIST.CODE,
  isLoading,
  dataQuery,
  isFetchingNextPage,
  hasNextPage,
      ...
      >
        ...
        >
          ...
          >
            ...
            {!isLoading &&
              dataQuery?.map((item) => {
                if (type === TYPE_DISPLAY_LIST.CODE) {
                  return (
                    <ItemCode
                      key={item._id}
                      images={item.images}
                ...
                } else if (type === TYPE_DISPLAY_LIST.BLOG) {
                  return <ItemBlog item={item} key={item._id} />;
                }
              })}
            {isFetchingNextPage &&
              Array.from({ length: LIMIT_RESULTS }).map((item, i) => (
